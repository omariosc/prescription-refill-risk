...
function P2ULogo() {
  return (
    <svg className="logo-svg" viewBox="0 0 1226.57 302.38" xmlns="http://www.w3.org/2000/svg">
...
export default function Header({ user, onLoginClick, onLogout, onHomeClick, onToolClick, onAdminClick, onAnalyticsClick }) {
  ...
  if (!user) {
    return (
      <header>
        <div className="hdr">
          <button className="logo-btn" onClick={onHomeClick} aria-label="Go to home">
            <P2ULogo />
          </button>
          <div style={{ flex: 1 }} />
        ...
        <div className="user-menu" ref={dropRef}>
          ...
          {dropdownOpen && (
            <div className="dropdown">
              <button className="dropdown-item" onClick={() => { setDropdownOpen(false); onHomeClick && onHomeClick(); }}>
              ...
              <button className="dropdown-item" onClick={() => { setDropdownOpen(false); onLogout && onLogout(); }}>
